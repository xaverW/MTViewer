...
import de.p2tools.mtviewer.controller.data.download.DownloadFieldNames;
...
public class DownloadEditDialogController extends PDialogExtra {
    ...
    private int setGrid() {
        ...
        //---------------------------------
        ++row;
        cbx[DownloadFieldNames.DOWNLOAD_INFO_FILE_NO].setSelected(download.isInfoFile());
        if (!isStarted) {
