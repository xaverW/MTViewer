...
public class TipListSearch {
    ...
    public static List<TipData> getTips() {
        ...
        String text = "In den Text-Suchfeldern werden die zuletzt eingegebenen " +
                ...
                "die gesamte Liste.";
        String image = "/de/p2tools/mtviewer/res/tips/search/search-1.png";
        ...
        image = "/de/p2tools/mtviewer/res/tips/search/search-2.png";
        ...
        image = "/de/p2tools/mtviewer/res/tips/search/search-3.png";
        pToolTip = new TipData(text, image);
        pToolTipList.add(pToolTip);
        ...
        image = "/de/p2tools/mtviewer/res/tips/search/search-4.png";
        pToolTip = new TipData(text, image);
        pToolTipList.add(pToolTip);
