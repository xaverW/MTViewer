...
package de.p2tools.mtviewer.controller.data.history;
...
public class HistoryList extends SimpleListProperty<HistoryData> {
    ...
    public synchronized void addFilmDataListToHistory(List<FilmData> filmList) {
        // Button oder Menü
...
//            }
    ...
    public synchronized void removeDownloadDataFromHistory(List<DownloadData> downloadList) {
        ...
        downloadList.forEach(download -> {
            ...
            hash.add(download.getFilm().getUrlHistory());
        });
