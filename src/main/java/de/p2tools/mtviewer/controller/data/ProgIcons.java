...
public class ProgIcons {
    ...
    public static P2IconInfo ICON_DIALOG_ON = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "dialog-ein.png", 16, 16);
    public static P2IconInfo IMAGE_ACHTUNG_64 = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "achtung_64.png", 64, 64);

    public static P2IconInfo ICON_BUTTON_RESET = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "button-reset.png", 16, 16);
    public static P2IconInfo ICON_BUTTON_PROPOSE = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "button-propose.png", 16, 16);
    ...
    public static P2IconInfo IMAGE_TABLE_FILM_PLAY = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "table-film-play.png", 14, 14);
    public static P2IconInfo IMAGE_TABLE_FILM_SAVE = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "table-film-save.png", 14, 14);
    public static P2IconInfo IMAGE_TABLE_DOWNLOAD_START = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "table-download-start.png", 14, 14);
    public static P2IconInfo IMAGE_TABLE_DOWNLOAD_DEL = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "table-download-del.png", 14, 14);
    public static P2IconInfo IMAGE_TABLE_DOWNLOAD_STOP = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "table-download-stop.png", 14, 14);
    public static P2IconInfo IMAGE_TABLE_DOWNLOAD_OPEN_DIR = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "table-download-open-dir.png", 14, 14);
    ...
    public static P2IconInfo ICON_BUTTON_MOVE_TOP = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "button-move-top.png", 16, 16);
    public static P2IconInfo ICON_BUTTON_MOVE_BOTTOM = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "button-move-bottom.png", 16, 16);
    public static P2IconInfo ICON_BUTTON_CLEAN = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "clean_16.png", 16, 16);
    public static P2IconInfo ICON_BUTTON_START_ALL = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "button-start-all.png", 16, 16);
    public static P2IconInfo ICON_BUTTON_STOP_ALL = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "button-stop-all.png", 16, 16);

    public static P2IconInfo FX_ICON_TOOLBAR_MENU = new P2IconInfo(ICON_PATH_LONG, ICON_PATH, "toolbar-menu.png", 18, 15);

    public static void initIcons() {
        iconList.forEach(p -> {
            String url = p.genUrl(P2IconInfo.class, MTViewerController.class, ProgConst.class, ProgIcons.class, P2LibConst.class);
            if (url.isEmpty()) {
