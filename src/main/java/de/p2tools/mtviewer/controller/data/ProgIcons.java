...
public class ProgIcons {
    ...
    public static P2Image ICON_DIALOG_ON = new P2Image(ICON_PATH_LONG, "dialog-ein.png", 16, 16);
    ...
    public static P2Image FX_ICON_TOOLBAR_MENU = new P2Image(ICON_PATH_LONG, "toolbar-menu.png", 18, 15);
}
